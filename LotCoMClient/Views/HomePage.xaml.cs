...
public partial class HomePage : ContentPage {
    ...
    public async void OnLeftFramePanelBody_SteelPrintingDataButtonClicked(object sender, EventArgs e) {
        ...
        DataTableSelectorPage SteelPage = new DataTableSelectorPage("\\\\144.133.122.1\\Lot Control Management\\Database\\data_tables\\prints\\4134-CRV-Pipe-Comp.txt", "Steel Printing Data");
    ...
    public async void OnLeftFramePanelBody_AluminumPrintingDataButtonClicked(object sender, EventArgs e) {
        ...
        DataTableSelectorPage AluminumPage = new DataTableSelectorPage("\\\\144.133.122.1\\Lot Control Management\\Database\\data_tables\\prints\\4320-NP2-OP-Cover-MC.txt", "Aluminum Printing Data");
