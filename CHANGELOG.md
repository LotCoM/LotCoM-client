...
- **[feature/project](https://github.com/Yamada-North-America/LotCom-client/pull/1)**
  - Create and upload .NET MAUI project.
  - Create Repository and Project documentation.
  - Rough roadmapping.
- **[feature/2](https://github.com/Yamada-North-America/LotCom-client/pull/3)**
  - Implement `DataTable.cs` class ([#2](https://github.com/Yamada-North-America/LotCom-client/issues/2))
  - **New Classes:**
    - `DataTable.cs`: Provides controlled access and interaction with LotCom database tables.
- **[feature/4](https://github.com/Yamada-North-America/LotCom-client/pull/5)**
  - Implement Data Record class group ([#4](https://github.com/Yamada-North-America/LotCom-client/issues/4))
...
- **[feature/6](https://github.com/Yamada-North-America/LotCom-client/pull/8)**
  - Import Process data class group from LotCom-printer ([#6](https://github.com/Yamada-North-America/LotCom-client/issues/6)).
...
- **[feature/7](https://github.com/Yamada-North-America/LotCom-client/pull/9)**
  - Remove ambiguity in variable data fields of `DataRecord.cs` ([#7](https://github.com/Yamada-North-America/LotCom-client/issues/7))

# `0.2.0`
### Print Data Pages
- **[feature/11](https://github.com/Yamada-North-America/LotCom-client/pull/14)**
  - Implement `DataTablePage` class to display `DataTable` data in a `ListView` ([#11](https://github.com/Yamada-North-America/LotCom-client/issues/11)).
...
- **[feature/13](https://github.com/Yamada-North-America/LotCom-client/pull/15)**
  - Implement an improved `Taskbar` application Icon ([#13](https://github.com/Yamada-North-America/LotCom-client/issues/13)).
- **[bug/18](https://github.com/Yamada-North-America/LotCom-client/pull/19)**
  - Resolve an issue in `DataTable` that causes an application crash when instantiating from an empty database table ([#18](https://github.com/Yamada-North-America/LotCom-client/issues/18)).
- **[feature/16](https://github.com/Yamada-North-America/LotCom-client/pull/20)**
  - Implement `NavigationPage` navigation in `App.xaml` class ([#16](https://github.com/Yamada-North-America/LotCom-client/issues/16)).
...
- **[feature/17](https://github.com/Yamada-North-America/LotCom-client/pull/21)**
  - Asynchronize `DataTable` and `DataTablePage` data loading actions ([#17](https://github.com/Yamada-North-America/LotCom-client/issues/17)).
...
- **[feature/22](https://github.com/Yamada-North-America/LotCom-client/pull/23)**
  - Major UI Color and Style tweaks ([#22](https://github.com/Yamada-North-America/LotCom-client/issues/22)).
...
# `0.3.0`
### Scan Data Pages
- **[feature/25](https://github.com/Yamada-North-America/LotCom-client/pull/26)**
  - Implement Scanning Data Page navigation and logic ([#25](https://github.com/Yamada-North-America/LotCom-client/issues/25))
  - Implement ScanAddress property in DataRecord classes (for ScanRecords).
- **[bug/27](https://github.com/Yamada-North-America/LotCom-client/pull/28)**
  - Resolve ([#27](https://github.com/Yamada-North-America/LotCom-client/issues/27)).
